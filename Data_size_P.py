...
def hc(hc_queue):
    num_bs = 5
    num_irs_ele=50
    num_generation = 1 # Number of iterations for Hill Climbing  (Increased for better search)
    num_uav_irs = 8
...
def ga(ga_queue):
    num_bs = 5
    num_irs_ele=50
    num_generation = 1 # Number of generations, increased for GA to evolve (Increased for better search)
    num_uav_irs = 8
