...
for l in range(num_bs):
    ...
    for k in range(num_uav_irs):
        ...
        Wl_value = Wl[k]
        best_fitness_across_generations = [] # List to store best fitness in each generation
        ...
        for j in range(num_generation):
            ...
            best_fitness_across_generations.append(population[0]['fitness']) # Store best fitness of current generation
        ...
        all_best_combinations.append({
            ...
            'fitness_history': best_fitness_across_generations # Store fitness history for plotting
        })
