...
eta=10
kappa=0.5
D_m_current=0.49 # keeping Dm global as used in the code

Bh = (1 - 2.2558 * pow(10, -5) * H)**4.2577
...
def E_kml_har(P_m_har, T_m_har,h_kml_har):
    return kappa*P_m_har*T_m_har*h_kml_har
