...
if __name__ == "__main__":
    ...
    for i in range(len(T_m_range)):
        ...
        if hc_a_fitness < c2ga_fitness:
            ...
            print(f"IRS {data_size:.1f}: Tie in Energy ({hc_a_fitness:.2f} vs {c2ga_fitness:.2f}) - 0.00% Improvement")
        ...
        print(f"IRS{data_size:.1f}: {better_algorithm} is better by {percentage_improvement:.2f}% (Energy: {better_fitness:.2f} vs {worse_fitness:.2f})")
