...
fitness_sums_T_m = [] # Store sum of fitness values for each p_max

for T_m in range(5, 15): # Iterate p_max from 1 to 10
    ...
    fitness_sums_T_m.append(sum_fitness_current_p_max) # Store sum of fitness for this p_max
...
# plt.figure(figsize=(10, 6))
# T_m_range = range(5, 11)
# plt.plot(T_m_range, fitness_sums_p_max, marker='o', linestyle='-')
# plt.xlabel('P_max Value')
# plt.ylabel('Sum of Best Fitness Values (Auctioned Assignments)')
# plt.title('Sum of Best Fitness Values vs T_m')
# plt.grid(True)
# plt.xticks(T_m_range)
# plt.tight_layout()
# plt.show()
...
# p_km_max=10
# # T_m=10
T_m_values = range(5, 15) # T_m values from 1
...
for T_m in T_m_values: # Loop through T_m values
    all_best_combinations = []
    all_best_individuals = []
...
# # g_l_km_col=IRS_UP['h_l_km'] # number of irs elemnt is 50
# # g_l_m_col=IRS_UP['h_l_m'] # number of irs element is 50
# pbase = pd.read_csv(r'BS_data.csv')
# uav = pd.read_csv(r'UAV_data.csv')
# people = pd.read_csv(r'people_data.csv')
# IRS=pd.read_csv(r'IRS_data.csv')
# IRS_UP=pd.read_csv(r'IRS_data_up.csv')
...
T_m_values = range(5, 15) # p_max from 1 to 10
...
for T_m in T_m_values:
    ...
    if current_sum_fitness > previous_sum_fitness: # If current sum is worse than previous
        fitness_sum_for_p_max[T_m] = previous_sum_fitness # Retain previous sum
    else:
        fitness_sum_for_p_max[T_m] = current_sum_fitness # Use current sum
...
T_m_plot_values = list(fitness_sum_for_p_max.keys())
fitness_sum_plot_values = list(fitness_sum_for_p_max.values())

# plt.figure(figsize=(10, 6))
# plt.plot(T_m_plot_values, fitness_sum_plot_values, marker='o', linestyle='-')
# plt.xlabel('p_max Value')
# plt.ylabel('Sum of Fitness Values Across Iterations')
# plt.title('Sum of Fitness Values vs. T_m')
# plt.grid(True)
# plt.xticks(T_m_plot_values)
# plt.tight_layout()
# plt.show()
...
T_m_range = range(5, 15)


plt.plot(T_m_range, fitness_sums_T_m, marker='s', linestyle='--', label='hill climb')
plt.plot(T_m_range, fitness_sums_p_max, marker='*', linestyle='--', label='Genetic Algorithm')
plt.plot(T_m_plot_values, fitness_sum_plot_values, marker='o', linestyle='--', label='Random Search')
plt.xlabel('T_m Value')
plt.ylabel('Sum of Best Fitness Values (Auctioned Assignments)')
plt.title('Comparison of Algorithm Performance vs. T_m')
plt.grid(True)
plt.xticks(T_m_plot_values)
plt.legend()
plt.tight_layout()
