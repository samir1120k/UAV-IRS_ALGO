...
for variance in variance_values:
    ...
    fitness_results_vs_variance[variance] = sum_best_fitness_final_gen_variance
...
plt.ylabel('Sum of Best Fitness Values (Final Generation)')
plt.title('Impact of Mutation Variance on Sum of Best Fitness')
plt.grid(True)
