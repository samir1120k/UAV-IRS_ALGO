...
if __name__ == "__main__":
    ...
    plt.plot(height, fitness_sums_GA, label = "C2GA")
    ...
    for i in range(len(height)):
        ...
        if hc_a_fitness < c2ga_fitness:
            ...
            print(f"Height {data_size:.1f}: Tie in Energy ({hc_a_fitness:.2f} vs {c2ga_fitness:.2f}) - 0.00% Improvement")
        ...
        print(f"Height{data_size:.1f}: {better_algorithm} is better by {percentage_improvement:.2f}% (Energy: {better_fitness:.2f} vs {worse_fitness:.2f})")
    ...
    print(f"  HC-A was better in {better_algorithm_counts['HC-A']} out of {len(height)} cases.")
    print(f"  C2GA was better in {better_algorithm_counts['C2GA']} out of {len(height)} cases.")
    print(f"  Tie in {better_algorithm_counts['Tie']} out of {len(height)} cases.")
