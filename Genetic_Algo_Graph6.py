...
generation_fitness_values = [] # Store fitness values for each generation for plotting
...
for l in range(num_bs):
    ...
    for k in range(num_uav_irs):
        ...
        for i in range(50):
            ...
            bs_uav_generation_fitness = [] # List to store best fitness in each generation for current BS-UAV pair
        ...
        for j in range(num_generation):
            ...
            bs_uav_generation_fitness.append(population[0]['fitness']) # Store best fitness of current generation
        ...
        all_best_combinations.append({
            'bs_index': l,
            'uav_index': k,
            'best_fitness': population[0]['fitness'], # Store best fitness for this BS-UAV pair (final generation)
            'best_individual': best_individual_pair,
            'generation_fitness': bs_uav_generation_fitness # Store generation fitness values
        })
