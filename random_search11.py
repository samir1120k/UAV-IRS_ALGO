...
# Print and Plotting
print("\n--- Best Unique UAV Assignments (Auction Based Method) - Random Search ---") # Modified print statement
...
for assignment in best_assignments:
    ...
    print(f"   Generation: {best_ind['generation']}, Type: {best_ind['type']}") # Indicate RS type
...
if best_pair_for_plot and best_pair_for_plot['best_individual']['fitness'] != float('inf'): # Added check before plotting
    ...
    plt.title(f'Fitness Exploration Over Iterations for Best BS-UAV Pair (RS) (BS {best_pair_for_plot['bs_index']}, UAV {best_pair_for_plot['uav_index']})') # Modified title for RS
    plt.grid(True)
...
plt.title('Sum of Valid Fitness Values Explored Across Iterations (Random Search)') # Modified title for RS
plt.xlabel('Iteration Number') # Modified x-label for RS
