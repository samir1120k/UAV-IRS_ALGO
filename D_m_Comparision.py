...
# plt.xlabel('D_m Value')
# plt.ylabel('Sum of Best Fitness Values (Auctioned Assignments)')
# plt.title('Sum of Best Fitness Values vs D_m')
# plt.grid(True)
...
for Dm in D_m_values: # Iterate p_max from 1 to 10
    ...
    fitness_sum_for_p_max[Dm] = sum(sum_fitness_per_generation)


# Plotting graph for p_max vs Sum of Fitness
D_m_plot_values = list(fitness_sum_for_p_max.keys())
fitness_sum_plot_values = list(fitness_sum_for_p_max.values())

# plt.figure(figsize=(10, 6))
# plt.plot(D_m_plot_values, fitness_sum_plot_values, marker='o', linestyle='-')
# plt.xlabel('D_m Value')
# plt.ylabel('Sum of Fitness Values Across Iterations')
# plt.title('Sum of Fitness Values vs. D_m')
# plt.grid(True)
# plt.xticks(D_m_plot_values)
# plt.tight_layout()
# plt.show()
...
plt.plot(T_m_range, fitness_sums_D_m, marker='s', linestyle='--', label='hill climb')
plt.plot(T_m_range, fitness_sums_p_max, marker='*', linestyle='--', label='Genetic Algorithm')
plt.plot(D_m_plot_values, fitness_sum_plot_values, marker='o', linestyle='--', label='Random Search')
plt.xlabel('D_m Value')
plt.ylabel('Sum of Best Fitness Values (Auctioned Assignments)')
plt.title('Comparison of Algorithm Performance vs. D_m')
plt.grid(True)
plt.xticks(D_m_plot_values)
plt.legend()
plt.tight_layout()
