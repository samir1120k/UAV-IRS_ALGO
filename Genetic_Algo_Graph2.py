...
for l in range(num_bs):
    ...
    for k in range(num_uav_irs):
        ...
        #i want to store the data of every generation of each best pair of uav and base station
        #then try to plot the graph between the each generation and sum of fitness value of all the best pair 
        # of uav and base station in the generation
